    ...
    : describe("Raffle", async function () {
          ...
          describe("enterRaffle", function () {
              it("reverts when you don't pay enough", async function () {
                  ...
                  console.log("enterRaffle:1")
              })
              it("records players when they enter", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  const playerFromContract = await raffle.getPlayer(0)
                  console.log("enterRaffle:2")
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks winner,resets the lottery,and sends", async function () {
                  ...
                  for (
                      ...
                      await acccountConnectedRaffle.enterRaffle({ value: raffleEntranceFee })
                  }
                  ...
                  await new Promise(async (resolve, reject) => {
                      ...
                      console.log(`requestId:${txReceipt.events[1].args.requestId}`)
